...
async function streamConversationMessage(token, conversationId, content, handlers) {
    ...
    if (!response.ok || !response.body) {
        ...
        if (response.status === 401 || code === 40101 || code === 40102 || code === 40103) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$http$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["notifySessionExpired"])();
        }
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$http$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiRequestError"](payload?.message || "Stream request failed", response.status, code);
    }
...
function useAssistantChat() {
    const { token, currentUser, isAuthReady, openAuthModal, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$components$2f$auth$2d$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
...
function AssistantWorkspace() {
    ...
    const { openAuthModal } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$components$2f$auth$2d$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const { token, currentUser, conversations, activeConversationId, messages, messageDraft, setMessageDraft, avatarDraft, setAvatarDraft, presence, isBootstrapping, isSending, isDrawerOpen, setIsDrawerOpen, errorMessage, handleConversationSelect, handleCreateConversation, handleSendMessage, handleSendAvatarMessage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$assistant$2f$hooks$2f$use$2d$assistant$2d$chat$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAssistantChat"])();
    const statusText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>PRESENCE_LABEL[presence] ?? "待命中", [
        presence
    ]);
...
//# sourceMappingURL=features_assistant_ec4e7335._.js.map