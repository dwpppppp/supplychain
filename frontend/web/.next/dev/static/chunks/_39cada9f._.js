...
"[project]/features/course/api/course.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function fetchCourseChapters() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["request"])("/course/chapters");
}
function fetchChapterDetail(token, chapterId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["request"])(`/course/chapters/${chapterId}`, {
        token
    });
}
function askChapterQuestion(token, chapterId, payload) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["request"])(`/course/chapters/${chapterId}/ask`, {
        method: "POST",
        token,
        body: payload
    });
...
function saveChapterNote(token, chapterId, payload) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["request"])(`/course/chapters/${chapterId}/notes`, {
        method: "POST",
        token,
        body: payload
    });
...
function updateChapterProgress(token, chapterId, progressPercent, lastReadPosition = 0) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["request"])(`/course/chapters/${chapterId}/progress`, {
        method: "PUT",
        token,
        body: {
...
"[project]/app/(platform)/course/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$course$2f$api$2f$course$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/course/api/course.ts [app-client] (ecmascript)");
;
...
function getStaticAssetUrl(path) {
    ...
    const origin = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"].replace(/\/api\/v1\/?$/, "");
...
function renderHtmlNode(node, baseUrl, key) {
    ...
    if (tagName === "h2" && element.closest("section[id^='section-']")) {
        ...
        if (!element.querySelector(".section-num")) {
            ...
            if (sectionNumber) {
                children.unshift(/*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement("span", {
    ...
    return /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(tagName, props, ...children);
}
function CourseHtmlDocument({ html, baseUrl }) {
    ...
    const content = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CourseHtmlDocument.useMemo[content]": ()=>{
            if (!html) return null;
            ...
            return nodes.map({
                "CourseHtmlDocument.useMemo[content]": (node, index)=>renderHtmlNode(node, baseUrl, `course-doc-${index}`)
            }["CourseHtmlDocument.useMemo[content]"]);
        }
    }["CourseHtmlDocument.useMemo[content]"], [
        baseUrl,
...
_s(CourseHtmlDocument, "nOKcCO/DZR7PO8GpYaNDiNh8hVA=");
_c = CourseHtmlDocument;
function CoursePageContent() {
    _s1();
    const searchParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"])();
    const { token, isAuthenticated, openAuthModal } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$components$2f$auth$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [readerStatus, setReaderStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("idle");
    const [readerError, setReaderError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [askStatus, setAskStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("idle");
    const [askError, setAskError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [courseHtml, setCourseHtml] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [selectionBubble, setSelectionBubble] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [inlineAskPanel, setInlineAskPanel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const courseReaderRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const flatChapters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CoursePageContent.useMemo[flatChapters]": ()=>flattenChapters(chapters)
    }["CoursePageContent.useMemo[flatChapters]"], [
        chapters
    ]);
    const readableChapters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CoursePageContent.useMemo[readableChapters]": ()=>getReadableChapters(chapters)
    }["CoursePageContent.useMemo[readableChapters]"], [
        chapters
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CoursePageContent.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$course$2f$api$2f$course$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCourseChapters"])().then({
                "CoursePageContent.useEffect": (data)=>{
                    ...
                    setExpandedIds(new Set(nextChapters.map({
                        "CoursePageContent.useEffect": (chapter)=>chapter.id
                    }["CoursePageContent.useEffect"])));
                    setActiveChapterId(defaultId);
                }
            }["CoursePageContent.useEffect"]).catch({
                "CoursePageContent.useEffect": ()=>{
                    ...
                    setExpandedIds(new Set(FALLBACK_CHAPTERS.map({
                        "CoursePageContent.useEffect": (chapter)=>chapter.id
                    }["CoursePageContent.useEffect"])));
                    setActiveChapterId(defaultId);
                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CoursePageContent.useEffect": ()=>{
            ...
            setReaderError(null);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$course$2f$api$2f$course$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchChapterDetail"])(token, activeChapterId).then({
                "CoursePageContent.useEffect": (data)=>{
                    setDetail(data);
                    setReaderStatus("idle");
                }
            }["CoursePageContent.useEffect"]).catch({
                "CoursePageContent.useEffect": (error)=>{
                    setDetail(null);
    ...
    const askSelectedText = async ()=>{
        ...
        setAnswer("");
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$course$2f$api$2f$course$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["askChapterQuestion"])(token, activeChapterId, {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CoursePageContent.useEffect": ()=>{
            ...
            const updateSelection = {
                "CoursePageContent.useEffect.updateSelection": (event)=>{
                    ...
                    window.setTimeout({
                        "CoursePageContent.useEffect.updateSelection": ()=>{
                    ...
                    }["CoursePageContent.useEffect.updateSelection"], 0);
                }
            }["CoursePageContent.useEffect.updateSelection"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CoursePageContent.useEffect": ()=>{
            ...
            fetch(htmlUrl, {
                ...
                "CoursePageContent.useEffect": (response)=>{
                    if (!response.ok) {
                        throw new Error("HTML document unavailable");
                    }
                    return response.text();
                }
            }["CoursePageContent.useEffect"]).then({
                "CoursePageContent.useEffect": (source)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CoursePageContent.useEffect": ()=>{
            ...
            const frameId = requestAnimationFrame({
                "CoursePageContent.useEffect.frameId": ()=>{
            ...
            return ({
                "CoursePageContent.useEffect": ()=>cancelAnimationFrame(frameId)
            })["CoursePageContent.useEffect"];
        }
    }["CoursePageContent.useEffect"], [
        activeChapterId,
    ...
    const renderChapterList = (items)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ol", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    !isAuthenticated ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        lineNumber: 719,
                        columnNumber: 11
                    }, this) : readerStatus === "loading" && !courseHtml ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        lineNumber: 731,
                        columnNumber: 11
                    }, this) : readerStatus === "error" && !courseHtml ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                            courseHtml && htmlUrl ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                className: "course-html-panel",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CourseHtmlDocument, {
                                    html: courseHtml,
                                    baseUrl: htmlUrl
                                }, void 0, false, {
                                    fileName: "[project]/app/(platform)/course/page.tsx",
                                ...
                                lineNumber: 742,
                                columnNumber: 15
                            }, this) : pdfUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                            ...
                            !courseHtml && !pdfUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                className: "course-state",
                                children: "当前章节暂无课程文档。"
                            }, void 0, false, {
                                fileName: "[project]/app/(platform)/course/page.tsx",
            ...
            selectionBubble && !inlineAskPanel && !isAskModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                type: "button",
            ...
            inlineAskPanel && !isAskModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    inlineAskPanel.status === "asking" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        lineNumber: 792,
                        columnNumber: 13
                    }, this) : inlineAskPanel.error ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            isAskModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: [
                        ...
                        askError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(CoursePageContent, "E2C43gkSBD7kZxbeSGDMgkAwPgg=", false, function() {
    return [
...
function CoursePage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CoursePageContent, {}, void 0, false, {
            fileName: "[project]/app/(platform)/course/page.tsx",
            lineNumber: 857,
            columnNumber: 7
        }, this)
...
_c2 = CoursePage;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "CourseHtmlDocument");
__turbopack_context__.k.register(_c1, "CoursePageContent");
...
//# sourceMappingURL=_39cada9f._.js.map