...
async function streamConversationMessage(token, conversationId, content, handlers) {
    ...
    if (!response.ok || !response.body) {
        const payload = await response.json().catch(()=>null);
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiRequestError"](payload?.message || "Stream request failed", response.status, payload?.code || response.status);
    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAssistantChat.useEffect": ()=>{
            const syncSessionState = {
                "useAssistantChat.useEffect.syncSessionState": ()=>{
                    const savedToken = window.localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEYS"].accessToken);
                    const savedUser = readStoredUser();
            ...
            window.addEventListener(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APP_EVENTS"].sessionChanged, syncSessionState);
            return ({
                "useAssistantChat.useEffect": ()=>{
                    window.removeEventListener(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APP_EVENTS"].sessionChanged, syncSessionState);
                }
            })["useAssistantChat.useEffect"];
        }
    }["useAssistantChat.useEffect"], []);
...
_s(useAssistantChat, "Ipu+e6goM7nE76YMQa4sKCHANqI=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function AssistantWorkspace() {
    ...
    const { token, currentUser, conversations, activeConversationId, messages, messageDraft, setMessageDraft, avatarDraft, setAvatarDraft, presence, isBootstrapping, isLoggingIn, isSending, isDrawerOpen, setIsDrawerOpen, errorMessage, loginForm, setLoginForm, handleLoginSubmit, handleConversationSelect, handleCreateConversation, handleSendMessage, handleSendAvatarMessage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$assistant$2f$hooks$2f$use$2d$assistant$2d$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAssistantChat"])();
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: recentAvatarMessages.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AssistantWorkspace, "ze8m9JE9bM03ZGpa7/oTFPNHeEE=", false, function() {
    return [
...
//# sourceMappingURL=_6e8c1ea9._.js.map